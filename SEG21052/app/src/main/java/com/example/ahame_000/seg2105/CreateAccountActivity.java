...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    public void doneCreateNewAccBttnClick(View view) {
        ...
        if(DM.getAllAccountEmails().contains(emailString)) {
            TextView sameEmail = findViewById(R.id.tvWaringMessage);
            sameEmail.setText("The email you entered is already being used!");
            return;
        }
